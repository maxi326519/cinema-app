import { ADD_MOVIE_FAVORITE, REMOVE_MOVIE_FAVORITE, GET_MOVIES, GET_DETAILS } from '../actions/index'
...
export default function rootRedux(state = initialState, action){
    switch(action.type){
        ...
        case REMOVE_MOVIE_FAVORITE:
            return {
                ...state,
                favourite: state.favourite.filter(movie => movie.imdbID !== action.payload)
            }
